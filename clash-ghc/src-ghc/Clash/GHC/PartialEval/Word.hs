...
module Clash.GHC.PartialEval.Word
  ( wordPrims
  ) where
...
wordPrims = HashMap.fromList
  ...
  , ("GHC.Prim.quotWord#", withExceptions (liftBinary# quotWord#))
  , ("GHC.Prim.remWord#", withExceptions (liftBinary# remWord#))
  , ("GHC.Prim.quotRemWord#", withExceptions (liftW_W_WW quotRemWord#))
  , ("GHC.Prim.quotRemWord2#", withExceptions primQuotRemWord2)
  ...
  , ("GHC.Prim.pfCnt8#", liftUnary# popCnt8#)
  , ("GHC.Prim.pfCnt16#", liftUnary# popCnt16#)
  , ("GHC.Prim.pfCnt32#", liftUnary# popCnt32#)
  , ("GHC.Prim.pfCnt64#", liftUnary# popCnt64#)
  , ("GHC.Prim.pfCnt#", liftUnary# popCnt#)
  ...
  , ("GHC.Types.W#", liftBox)
  , ("GHC.Types.W8#", liftBox)
  , ("GHC.Types.W16#", liftBox)
  , ("GHC.Types.W32#", liftBox)
  , ("GHC.Types.W64#", liftBox)
  ]

primQuotRemWord2 :: PrimImpl
primQuotRemWord2 ev p args
  | [Left x, Left y, Left z] <- args
  = do !(UWord (W# a)) <- fromTermOrValue ev x
       !(UWord (W# b)) <- fromTermOrValue ev y
       !(UWord (W# c)) <- fromTermOrValue ev z
